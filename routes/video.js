...
var twitter = 'https://api.twitter.com/oauth/authenticate?oauth_token=jmHQIQAAAAAA-ZVUAAABcnpR2Eg';
let browser;
...
// Chạy browser với chế độ headless:false, tức là có giao diện
                ...
                if (commentCount.toString() !== '0'){
                    ...
                    ava_user = await page2.evaluate(() =>
                        Array.from(document.querySelectorAll('[class="jsx-86236896 jsx-630386149 comment-content level-1 comment-pc"] a div img'),
                            e => e.src));
            ...
            res.render('video',{
                data:{video:getImgSrc, user:userid, avatar:avatar, comment:comments ,
                    ...
                    des:des, music:music, avaUser:ava_user, heart:heart, commentCount:commentCount, veri:veri, music_link:musicid, userlink:userlinkID}});
